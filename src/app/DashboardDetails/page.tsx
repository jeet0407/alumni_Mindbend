      ...
      <div className="bg-white shadow-lg sm:rounded-xl mt-20 overflow-hidden border border-gray-100 transition-all hover:shadow-md">
        <div className="px-6 py-5 bg-gradient-to-r from-blue-50 via-indigo-50 to-blue-50 border-b border-gray-200">
          <div className="flex items-center">
            ...
            <h3 className="text-xl font-bold leading-6 text-gray-900">Profile Information</h3>
          </div>
            ...
            <div className="border-b border-gray-100 pb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div className="md:col-span-2 group">
                  ...
                  <p className="mt-1 text-xs text-gray-500">Please include both city and country</p>
                </div>
                ...
                <div className="md:col-span-2 mt-2">
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    Share your professional journey, achievements, and interests
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="relative group">
                  ...
                  <p className="mt-1 text-xs text-gray-500 invisible group-hover:visible transition-opacity">
                    Add your LinkedIn URL to connect with professional networks
                  </p>
                </div>
