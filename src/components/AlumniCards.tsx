          ...
          alumniData[selectedYear]?.length > 0 && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
              {alumniData[selectedYear].map((person) => (
                <div
                  key={person.id}
                  className="bg-white rounded-xl overflow-hidden shadow-lg border border-gray-200 hover:shadow-xl transition-all duration-700 hover:border-blue-300 h-110 perspective-1000 group w-75"
                >
                  ...
                  <div className="relative w-full h-full  transition-transform duration-700 transform-style-preserve-3d group-hover:rotate-y-180">
                    ...
                    <div className="absolute w-full h-full backface-hidden">
                      {/* Profile image */}
                      <div className="relative h-97 bg-gradient-to-r from-blue-100 to-blue-50">
                        {person.image ? (
                          <Image
                            src={person.image}
